...
curl -XPOST -H "Content-type: application/json" -d '{ "message" : "Lorem ipsum dolor sit amet, consectetur adipiscing elit.", "delivery" : "sms", "target" : "+31xxxxxxxxxx" }' $URL; echo

curl -XPOST -H "Content-type: application/json" -d '{ "message" : "I dont know boss.", "delivery" : "email", "target" : "asd@world.com" }' $URL; echo
curl -XPOST -H "Content-type: application/json" -d '{ "message" : "I dont know boss.", "delivery" : "sms", "target" : "+31xxxxxxxxxx" }' $URL; echo